      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
        ...
        <section className="mb-12 animate-fade-in-up">
          <div className="flex items-center space-x-3 mb-4 sm:mb-6 px-2 sm:px-0">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Latest Announcements</h2>
          </div>
          
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-2xl border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            {announcements.length === 0 ? (
              ...
              <div className="h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800 pr-2">
        ...
        <section className="mb-12 animate-fade-in-up animation-delay-400">
          ...
          <div className="grid gap-4 sm:gap-8 grid-cols-1 sm:grid-cols-2 max-w-4xl mx-auto px-2 sm:px-0">
            {teamMembers.map((member, index) => (
              <div
                key={member.name}
                className="group relative bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-gray-750 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border border-gray-200 dark:border-transparent hover:border-blue-300 dark:hover:border-blue-500"
                style={{
        ...
        <section className="mb-12 animate-fade-in-up animation-delay-600">
          <div className="text-center mb-6 sm:mb-8 px-2 sm:px-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">View assigned tasks and progress</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 mx-2 sm:mx-0 border border-gray-200 dark:border-transparent transition-colors duration-300">
            <div className="text-center">
              <p className="text-gray-600 dark:text-gray-400 mb-4">Check your assigned tasks and deadlines</p>
              <a
                href="/tasks"
        ...
        <section className="mb-12 animate-fade-in-up animation-delay-800">
          <div className="text-center mb-6 sm:mb-8 px-2 sm:px-0">
            ...
            <p className="text-gray-600 dark:text-gray-400">Share your experience and suggestions</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 mx-2 sm:mx-0 border border-gray-200 dark:border-transparent transition-colors duration-300">
            <div className="text-center">
              <p className="text-gray-600 dark:text-gray-400 mb-4">Help us improve by providing feedback on events</p>
              <a
                href="/feedback"
        ...
        {/* Footer */}
        <footer className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-8 mt-12 mx-2 sm:mx-0 border border-gray-200 dark:border-transparent transition-colors duration-300 animate-fade-in-up animation-delay-1000">
          <div className="text-center">
